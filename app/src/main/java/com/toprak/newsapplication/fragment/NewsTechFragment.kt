...
class NewsTechFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        _binding = FragmentNewsTechBinding.inflate(inflater, container, false)
        ...
        binding.categories.setOnClickListener{
            findNavController().navigate(R.id.action_newsTechFragment_to_bottomSheetFilter)
        }
    ...
    private fun setupRecyclerView(){
        ...
        mAdapter.onItemClicked = { article ->
            try{
                val action = NewsTechFragmentDirections.actionNewsTechFragmentToDetailsActivity2(article)
    ...
    private fun requestApiData(){
        ...
        mainViewModel.getNewsTech()
        mainViewModel.newsTechResponse.observe(viewLifecycleOwner) { response ->
            when(response){
